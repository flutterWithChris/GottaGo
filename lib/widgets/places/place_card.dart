...
class _PlaceCardState extends State<PlaceCard> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: googlePlace.details.get(widget.place.googlePlaceId),
        builder: (context, snap) {
          var data = snap.data;
          if (data is DetailsResponse == false ||
              snap.connectionState == ConnectionState.active) {
            return const Center(
              child: SizedBox(),
            );
          }
          if (data is DetailsResponse &&
            ...
            return ConstrainedBox(
                constraints:
                    const BoxConstraints(minHeight: 170, maxHeight: 202),
                child: InkWell(
                  onTap: () {
                                                                    ...
                                                                    Text(
                                                                      ...
                                                                      style: TextStyle(
                                                                          ...
                                                                          fontWeight: FontWeight
                                                                              .bold,
                                                                          color: data.result?.openingHours?.openNow == true
                                                                              ? Colors.white
                                                                              : Colors.black87),
                                                                    )
                                                                  ]),
