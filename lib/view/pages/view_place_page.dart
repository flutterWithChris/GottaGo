...
class ViewPlacePage extends StatefulWidget {
  ...
  @override
  State<ViewPlacePage> createState() => _ViewPlacePageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: CustomScrollView(
        ...
        slivers: [
          CategoryPageAppBar(scrollController: scrollController),
          FutureBuilder<bool?>(
                      ...
                      builder: (context, state) {
                        if (state is ViewPlaceLoaded) {
                          ...
                          if (selectedPlace.phoneNumber != null) {
                            placePhoneNumber = Uri(
                                scheme: 'tel', path: selectedPlace.phoneNumber);
                          }
                              ...
                              delegate: SliverChildListDelegate(
                                [
                                  ...
                                  Padding(
                                    ...
                                    child: Hero(
                                      tag: 'goButton-${widget.place.placeId}',
